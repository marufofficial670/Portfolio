  ...
  */
	...
	function preventOverflow(_ref) {
		...
		var _options$mainAxis = options.mainAxis,
			...
			tethomeffset =
				_options$tethomeffset === void 0 ? 0 : _options$tethomeffset;
		var overflow = detectOverflow(state, {
			boundary: boundary,
			rootBoundary: rootBoundary,
			padding: padding,
		...
		var referenceRect = state.rects.reference;
		var popperRect = state.rects.popper;
		var tethomeffsetValue =
			typeof tethomeffset === "function"
				? tethomeffset(
						Object.assign({}, state.rects, {
							placement: state.placement,
						})
				...
				: tethomeffset;
		var normalizedTethomeffsetValue =
			typeof tethomeffsetValue === "number"
				? {
		...
		if (checkMainAxis) {
			...
			var minOffset = isBasePlacement
				? referenceRect[len] / 2 -
				  ...
				  arrowLen -
				  arrowPaddingMin -
				  normalizedTethomeffsetValue.mainAxis
				: minLen -
				  arrowLen -
				  arrowPaddingMin -
				  normalizedTethomeffsetValue.mainAxis;
		...
		if (checkAltAxis) {
			...
			var _tetherMin = isOriginSide
				...
				: _offset -
				  ...
				  normalizedTethomeffsetValue.altAxis;
